...
```r
out_gt <- get_times(schedule = gt[[1]], id = ids_gt[[1]], simulator = "independent")  # giving it the wrong simulator on purpose

for (i in 2:length(ids_gt)) {
    out_gt[i, ] <- get_times(gt[[i]], ids_gt[[i]], simulator = "independent")  # giving it the wrong simulator on purpose
}
...
paste("For the 'group-think' simulator, the average proportion of time that individuals spent attached to their home group was ",
    mean(out_gt$time_at_home) %>%
        round(., 3), ", versus the desired value of ", round(time_to_leave/(time_to_leave +
        time_to_return), 3))
#> [1] "For the 'group-think' simulator, the average proportion of time that individuals spent attached to their home group was  0.726 , versus the desired value of  0.667"
```
...
paste("For the 'independent' simulator, the average proportion of time that individuals spent at their home patch was ",
    mean(out_ind$time_at_home) %>%
        round(., 3), ", versus the desired value of ", round(time_to_leave/(time_to_leave +
        time_to_return), 3))
#> [1] "For the 'independent' simulator, the average proportion of time that individuals spent at their home patch was  0.648 , versus the desired value of  0.667"
...
paste("For the 'non-independent' simulator, the average proportion of time that individuals spent at their home patch was ",
    mean(out_ni$time_at_home) %>%
        round(., 3), ", versus the desired value of ", round(time_to_leave/(time_to_leave +
        time_to_return), 3))
#> [1] "For the 'non-independent' simulator, the average proportion of time that individuals spent at their home patch was  0.638 , versus the desired value of  0.667"
...
paste("For the 'group-think' simulator, the average proportion of time that individuals spent with their core group was ",
    mean(out_gt$time_at_home) %>%
        round(., 3), ", versus the desired value of ", round(time_to_leave/(time_to_leave +
        time_to_return), 3))
#> [1] "For the 'group-think' simulator, the average proportion of time that individuals spent with their core group was  0.672 , versus the desired value of  0.667"
```
