...
In case `purrr` functions are unfamiliar, you can see examples of these functions in a more 'base R' style. `get_times()` needs the individual's schedule, the individual's name, and the simulator used to generate the data. We'll get the proportions for each individual in the simulation and average those values:
...
![](./simulator-comparison-get-rates-1-1.png)
...
![](./simulator-comparison-ggplot-proportion-time2-2.png)
