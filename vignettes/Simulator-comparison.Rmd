...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = "man/figures/simulator-comparison-"
)
```
...
The time intervals are the same for each individual regardless of whether or not they moved, which is why there are some rows where the state doesn't change.
