...
actual_graphs <- readRDS("~/actual_graphs.RDS")
out_grab_two <- readRDS("~/out_grab_two.RDS")
```
...
```{r zeros and ones, fig.height=30, fig.width=10}
...
```{r vis, fig.height=10, fig.width=5}
